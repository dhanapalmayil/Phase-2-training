...
namespace API_Many_to_Many__C_.Controllers
{
    ...
    public class BookAuthorsController : ControllerBase
    {
        ...
        public BookAuthorsController(BookAuthorContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.BookAuthor.Include(b=>b.Author).ToListAsync();
        }
        ...
        {
            var bookAuthor = await _context.BookAuthor.FirstOrDefaultAsync(a=>a.BookId==id);
            if (bookAuthor == null)
            {
                return NotFound();
            }
