...
namespace Sample1
{
    public partial class Form1 : Form
    {
        ...
        {
            XmlReader xmlread = XmlReader.Create(@"C:\Users\dhanapal.m\source\repos\Serialization\Serialization\bin\Debug\net8.0\Courses.xml");
            while (xmlread.Read())
            {
        ...
        {
            XDocument doc = XDocument.Load(@"C:\Users\dhanapal.m\source\repos\Serialization\Serialization\bin\Debug\net8.0\Courses.xml");
            //linq query
